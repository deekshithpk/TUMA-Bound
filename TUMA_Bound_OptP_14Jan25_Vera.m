function [P_opt, eps_opt, EbN0_dB_opt] = TUMA_Bound_OptP_14Jan25_Vera(k, n, Ma, Ka, R, num_discr_rho, P_input, P_frac, num_discr_P, Zero_prox,n_vec)%,n1,id_proxy)
tic
...
% Define P1_vec                                             
   ...
   rho_min_opt_P_vec=zeros(1, length(P1_vec));
    ...
    parfor i = 1:length(P1_vec)
        ...
        [pt,rho_min_opt]= TUMA_Bound_GivenP1_14Jan25(n, Ma, Ka, R, P1, n_vec, rho, t_vec); % Compute epsilon
